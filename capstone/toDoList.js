...
async function getData() {
    const listRes = await axios.get('http://api.bryanuniversity.edu/churchill_perry/list');
...
async function deleteLi() {
    ...
    let response = await axios.delete(`http://api.bryanuniversity.edu/churchill_perry/list/${listID}`);
    location.reload();
}
...
function updateLi() {
    ...
    axios.put(`http://api.bryanuniversity.edu/churchill_perry/list/${item.id}`, updates)
